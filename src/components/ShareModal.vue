...
export default class ShareModal extends Vue {
  ...
  get facebookUrl(){
    return `https://www.facebook.com/sharer/sharer.php?u=https://cualbondi.com.ar`
  }
  get whatsappUrl(){
    return this.isMobile()
      ? `whatsapp://send?text=https://cualbondi.com.ar`
      : `https://web.whatsapp.com/send?text=https://cualbondi.com.ar`
  }
  get facebookMessengerUrl(){
    return this.isMobile()
      ? `fb-messenger://share/?link=${encodeURIComponent('https://cualbondi.com.ar')}&app_id=516530425068934`
      : `http://www.facebook.com/dialog/send?app_id=516530425068934&redirect_uri=https://cualbondi.com.ar&link=https://cualbondi.com.ar`
  }
  get telegramUrl(){
    return `https://telegram.me/share/url?url=https://cualbondi.com.ar`
  }
